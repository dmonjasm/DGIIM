...
class CardDealer 
    ...
    def createSuppliesPackages() 
        ...
        @suppliesPackages.add(SuppliesPackage.new(5,30,8))
        @suppliesPackages.add(SuppliesPackage.new(15,20,10))
        @suppliesPackages.add(SuppliesPackage.new(20,50,10))
        @suppliesPackages.add(SuppliesPackage.new(23,40,5))
    ...
    def createWeapons() 
       ...
       @weapons.add(Weapon.new("Ray Gun",WeaponType::PLASMA,20))
    ...
    def createShieldBoosters() 
       ...
       @shieldBoosters.add(ShieldBooster.new("Escudo de Titanio", 5.0,2))
    end
