...
public class Damage {
    ...
    public String toString(){
        String salida= "Nº Escudos: " + nShields;
        
        if(weapons == null)
            salida = salida + "\nNº Armas: " + nWeapons + "\n";
        
        else{
            salida = salida + "Tipos Armas: \n";
            for(int i=0; i < weapons.size(); i++){
                if(weapons.get(i) == WeaponType.LASER)
                    salida = salida + "LASER\n";
                
                else if(weapons.get(i) == WeaponType.MISSILE)
                    salida = salida + "MISSILE\n";
                
                else
                    salida = salida + "PLASMA\n";
            }
        }
