...
int main(int argc, char** argv) {
    ...
    //Ingrediente debe tener operadores de consulta y de modificación por cada parámetro
    //además de sobrecarga de lectura y escritura
    ...
    cout << "Proteínas " << i.getProteinas() << endl;
...
//    /*****************************************************************/
//    
//    //SECTION 2: Test sobre el objeto Ingredientes. En primer lugar comprobamos que la
//    // sobrecarga de entrada/ salida esta bien. Y por lo tanto la operación de insertar
//    //Ponemos el puntero del ficheo al principio
//    
//    f.seekg(0);
...
//    
//    cout << endl << endl;
//    cout << "El número de ingredientes son "  all_ingre.size() << endl;
//    cout << "Dime un nombre de ingrediente: ";
//    string n;
//    getline(cin,n);
//    ingredientes ing = all_ingre.get(n);
//    if (ing.getNombre() != "Undefined"){
//        cout << "Informacion del ingrediente " << ing << endl;
...
//    cout << "Los ingredeintes de tipo " << tipo << "son: " << endl; ingre_tipo << endl;
