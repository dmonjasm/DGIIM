...
class ingredientes{
	...
	public:
		...
		*/
		...
		/**
		 * @brief Se devuelve un vector con todos los nombres de los ingredientes almacenados
		 * @return vector<string> que contiene todos los nombres de los ingredientes
		*/
		vector<string> getNombreIngredientes();
};
/**
