...
class Lec_Esc : public HoareMonitor
{
    ...
    public:
        ...
        void fin_escritura(){
            ...
            if(!lectura.empty())            //Si hay algún lector esperando se le indica que puede leer
                lectura.signal();
            
            else                            //Si no lo hay se indica al siguiente escritor que puede escribir (preferencia lectores)
                escritura.signal();
        }
};
