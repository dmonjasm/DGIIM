...
void funcion_filosofos( int id )
{
  ...
  while ( true )
  {
    ...
    if(id==0){  //Como el filósofo 0 coge el de su derecha primero ocurre que
                /*Si lo coge antes que F4, entonces F4 no puede solicitar T3 pues estará bloqueado esperando T4 y se rompe el interbloqueo
                  Si lo coge después de F4, entonces F0 no habrá reservado T4 y por tanto como no T0 no será reservado por F0 se rompe el interbloqueo
                */
