...
const int
   ...
   num_cons              = 5,
   id_buffer             = num_prod,
   num_procesos_esperado = num_prod+num_cons+1,  //Se espera un proceso más ya que se añade una hebra que comprueba que sea correcto
   num_items             = 20,                   //luego se esperan tantos procesos como num_prod+num_cons+ 1 buffer+ 1 test
   tam_vector            = 10,
